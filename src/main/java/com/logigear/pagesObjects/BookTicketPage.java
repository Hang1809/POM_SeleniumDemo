...
public class BookTicketPage extends GeneralPage {
    ...
    private By ddlDepartStation = By.name("DepartStation");
    private By ddlArriveStation = By.name("ArriveStation");
    ...
    private WebElement getDblDate() {
        return Constant.WEBDRIVER.findElement(dblDate);
    }

    private WebElement getDblDepartStation() {
        return Constant.WEBDRIVER.findElement(dblDepartStation);
    }

    private WebElement getDblArriveStation() {
        return Constant.WEBDRIVER.findElement(dblArriveStation);
    }

    private WebElement getDblSeatType() {
        return Constant.WEBDRIVER.findElement(dblSeatType);
    }

    private WebElement getDblTicketAmount() {
