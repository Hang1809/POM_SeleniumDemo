...
public class TC16_UserCanCancelATicket extends BaseTest {
    ...
    public void TC16() {
        ...
        String idBtnCancel = myTicketPage.getIdOfBtnCancel(rowNumber);
        ...
        String actualMsg = String.valueOf(myTicketPage.checkTicketDisappear(idBtnCancel));
        Assert.assertEquals(actualMsg, "true", "Can't cancel the ticket");
    }
}
